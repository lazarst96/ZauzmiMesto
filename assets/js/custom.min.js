...
$(document).ready(function(){
            $("body").on('change','input.tipusera',function(){
            if ($('#input1').prop('checked')){
                
                $("#table_companies").addClass("d-none");
                $("#table_clients").removeClass("d-none");
               
            }else{
                $("#table_clients").addClass("d-none");
                $("#table_companies").removeClass("d-none"); 
            }
        });
});